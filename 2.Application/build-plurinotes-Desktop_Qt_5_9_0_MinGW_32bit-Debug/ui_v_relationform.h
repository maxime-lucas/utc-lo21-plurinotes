...
public:
    ...
    void retranslateUi(QDialog *v_relationform)
    {
        ...
        labelOriented->setText(QApplication::translate("v_relationform", "Oriented ?", Q_NULLPTR));
        btnYes->setText(QApplication::translate("v_relationform", "yes", Q_NULLPTR));
        btnNo->setText(QApplication::translate("v_relationform", "No", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("v_relationform", "Cancel", Q_NULLPTR));
        btnSave->setText(QApplication::translate("v_relationform", "Save", Q_NULLPTR));
    } // retranslateUi

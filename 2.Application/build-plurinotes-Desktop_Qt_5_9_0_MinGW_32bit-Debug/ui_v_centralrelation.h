...
public:
    ...
    {
        V_CentralRelation->setWindowTitle(QApplication::translate("V_CentralRelation", "Form", Q_NULLPTR));
        btnEdit->setText(QApplication::translate("V_CentralRelation", "Edit", Q_NULLPTR));
        textTitle->setText(QApplication::translate("V_CentralRelation", "Title", Q_NULLPTR));
        labelID->setText(QApplication::translate("V_CentralRelation", "ID : 1", Q_NULLPTR));
        labelType->setText(QApplication::translate("V_CentralRelation", "Type", Q_NULLPTR));
        btnDelete->setText(QApplication::translate("V_CentralRelation", "Delete", Q_NULLPTR));
    } // retranslateUi

...
static const char qt_meta_stringdata_V_CoupleForm[] = {
    "V_CoupleForm\0\0checkFields()\0"
};
...
const QMetaObjectExtraData V_CoupleForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject V_CoupleForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V_CoupleForm,
      qt_meta_data_V_CoupleForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &V_CoupleForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_V_CoupleForm))

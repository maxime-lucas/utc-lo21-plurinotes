...
static const char qt_meta_stringdata_V_MultimediaForm[] = {
    "V_MultimediaForm\0\0checkFields()\0"
    "openFile()\0"
};
...
const QMetaObjectExtraData V_MultimediaForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject V_MultimediaForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V_MultimediaForm,
      qt_meta_data_V_MultimediaForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &V_MultimediaForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_V_MultimediaForm))

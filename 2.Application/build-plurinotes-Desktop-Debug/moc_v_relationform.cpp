...
static const char qt_meta_stringdata_V_RelationForm[] = {
    "V_RelationForm\0\0checkFields()\0"
};
...
const QMetaObjectExtraData V_RelationForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject V_RelationForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V_RelationForm,
      qt_meta_data_V_RelationForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &V_RelationForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_V_RelationForm))

...
public:
    ...
    {
        V_TaskForm->setWindowTitle(QApplication::translate("V_TaskForm", "Dialog", 0));
        labelWindowTitle->setText(QApplication::translate("V_TaskForm", "Task", 0));
        iDLabel->setText(QApplication::translate("V_TaskForm", "ID :", 0));
        titleLabel->setText(QApplication::translate("V_TaskForm", "Title :", 0));
        actionLabel->setText(QApplication::translate("V_TaskForm", "Action :", 0));
        priorityLabel->setText(QApplication::translate("V_TaskForm", "Priority :", 0));
        yesBtn->setText(QApplication::translate("V_TaskForm", "Yes", 0));
        noBtn->setText(QApplication::translate("V_TaskForm", "No", 0));
        toBeDoneOnLabel_2->setText(QApplication::translate("V_TaskForm", "to be done on :", 0));
        label->setText(QApplication::translate("V_TaskForm", "Add Deadline ?", 0));
        btnCancel->setText(QApplication::translate("V_TaskForm", "Cancel", 0));
        btnSave->setText(QApplication::translate("V_TaskForm", "Save", 0));
    } // retranslateUi

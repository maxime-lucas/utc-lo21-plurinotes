...
struct qt_meta_stringdata_V_Multiplenotes_t {
    QByteArrayData data[1];
    char stringdata[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_Multiplenotes_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_V_Multiplenotes_t qt_meta_stringdata_V_Multiplenotes = {
    {
QT_MOC_LITERAL(0, 0, 15) // "V_Multiplenotes"
...
const QMetaObject V_Multiplenotes::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_V_Multiplenotes.data,
      qt_meta_data_V_Multiplenotes,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_Multiplenotes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_Multiplenotes.stringdata))

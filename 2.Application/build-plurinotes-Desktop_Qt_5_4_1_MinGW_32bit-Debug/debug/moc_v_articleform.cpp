...
struct qt_meta_stringdata_V_ArticleForm_t {
    QByteArrayData data[3];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_ArticleForm_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_V_ArticleForm_t qt_meta_stringdata_V_ArticleForm = {
    {
QT_MOC_LITERAL(0, 0, 13), // "V_ArticleForm"
QT_MOC_LITERAL(1, 14, 11), // "checkFields"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "V_ArticleForm\0checkFields\0"
};
...
const QMetaObject V_ArticleForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V_ArticleForm.data,
      qt_meta_data_V_ArticleForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_ArticleForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_ArticleForm.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralNote_t, stringdata) + ofs \
...
const QMetaObject V_CentralNote::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_V_CentralNote.data,
      qt_meta_data_V_CentralNote,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_CentralNote::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralNote.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralArticle_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject V_CentralArticle::staticMetaObject = {
    { &V_CentralNote::staticMetaObject, qt_meta_stringdata_V_CentralArticle.data,
      qt_meta_data_V_CentralArticle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralArticle.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralMultimedia_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject V_CentralMultimedia::staticMetaObject = {
    { &V_CentralNote::staticMetaObject, qt_meta_stringdata_V_CentralMultimedia.data,
      qt_meta_data_V_CentralMultimedia,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralMultimedia.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralTask_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject V_CentralTask::staticMetaObject = {
    { &V_CentralNote::staticMetaObject, qt_meta_stringdata_V_CentralTask.data,
      qt_meta_data_V_CentralTask,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralTask.stringdata))

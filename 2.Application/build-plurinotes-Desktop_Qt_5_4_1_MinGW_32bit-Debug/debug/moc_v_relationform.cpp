...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_V_RelationForm_t, stringdata) + ofs \
...
const QMetaObject V_RelationForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V_RelationForm.data,
      qt_meta_data_V_RelationForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_RelationForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_RelationForm.stringdata))

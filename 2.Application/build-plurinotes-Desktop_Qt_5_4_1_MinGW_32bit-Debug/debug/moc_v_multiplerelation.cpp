...
struct qt_meta_stringdata_V_Multiplerelation_t {
    QByteArrayData data[1];
    char stringdata[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_Multiplerelation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_V_Multiplerelation_t qt_meta_stringdata_V_Multiplerelation = {
    {
QT_MOC_LITERAL(0, 0, 18) // "V_Multiplerelation"
...
const QMetaObject V_Multiplerelation::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_V_Multiplerelation.data,
      qt_meta_data_V_Multiplerelation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_Multiplerelation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_Multiplerelation.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralView_t, stringdata) + ofs \
...
const QMetaObject V_CentralView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_V_CentralView.data,
      qt_meta_data_V_CentralView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_CentralView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralView.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_Centralrelation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject V_Centralrelation::staticMetaObject = {
    { &V_CentralView::staticMetaObject, qt_meta_stringdata_V_Centralrelation.data,
      qt_meta_data_V_Centralrelation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_V_Centralrelation.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_V_CentralCouple_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject V_CentralCouple::staticMetaObject = {
    { &V_CentralView::staticMetaObject, qt_meta_stringdata_V_CentralCouple.data,
      qt_meta_data_V_CentralCouple,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_V_CentralCouple.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_V_MainView_t, stringdata) + ofs \
...
const QMetaObject V_MainView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_V_MainView.data,
      qt_meta_data_V_MainView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V_MainView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V_MainView.stringdata))
